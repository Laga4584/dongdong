    ...
    <div class="field pafw-ex-type">
        ...
        <div id="pafw_type_container">
            <div class="return_wrap">
                ...
                <label><img src="<?php echo PAFW()->plugin_url() . '/assets/images/m_icon_check.png'; ?>"><?php _e( '반품', 'pgall-for-woocommerce' ); ?></label>
            </div>
            <div class="exchange_wrap">
                <input type="radio" name="type" value="exchange">
                <label><img src="<?php echo PAFW()->plugin_url() . '/assets/images/m_icon_check.png'; ?>"><?php _e( '교환', 'pgall-for-woocommerce' ); ?></label>
            </div>
        </div>
    </div>
