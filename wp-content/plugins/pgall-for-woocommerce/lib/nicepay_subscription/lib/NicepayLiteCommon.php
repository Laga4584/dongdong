...
define("NICEPAY_MODULE_CL","LITE"); // TX/LITE ����
define("NICEPAY_MODULE_INFO","PHP_LITE_1.3.1"); // ���� ���� ���� ����
...
/**
 * AES ��ȣȭ (��������: PHP 4 >= 4.0.2, PHP 5, DEPRECATED PHP 7.1.0)
 * AES/ECB/PKCS5padding, ��ȣȭ�� Base64 ���ڵ�/���ڵ�
 */
...
/**
 * AES ��ȣȭ (��������: PHP 4 >= 4.0.2, PHP 5, DEPRECATED PHP 7.1.0)
 * AES/ECB/PKCS5padding, Base64 ���ڵ�/���ڵ��� ��ȣȭ
 */
