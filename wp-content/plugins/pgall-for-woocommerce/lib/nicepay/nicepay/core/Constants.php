...
define("TX_VERSION","1.1.2");
define("TX_VERSION_RELEASED_DATE","20180411");
define("TX_VERSION_FINAL_WRITER","naun_cjlee");

define("NICEPAY_MODULE_CL","TX"); // TX/LITE ����
define("NICEPAY_MODULE_INFO","PHP_TX_1.1.2"); // ���� ���� ���� ����
...
define("TENPAY_PAY_METHOD", "TENPAY"); // ��������=������
define("GIFT_SSG_PAY_METHOD", "GIFT_SSG"); // SSG�Ӵ�
define("QQPAY_PAY_METHOD", "TENPAY"); // QQ����=������
define("ALIPAY_PAY_METHOD", "ALIPAY"); // �ż���
...
define("SVC_CD_TENPAY","20"); //������=��ê����
define("SVC_CD_GIFT_SSG","21"); //SSG�Ӵ�
define("SVC_CD_QQPAY","22"); //QQ����
define("SVC_CD_ALIPAY","23"); //�˸�����
define("SVC_CD_BANK_SSG","24"); //SSG��������
...
define("USE_REQUEST_TID", "UseRequestTID"); // ������ ��û TID �̿� ����
?>
