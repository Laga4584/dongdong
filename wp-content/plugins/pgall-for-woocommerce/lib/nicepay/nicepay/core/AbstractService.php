...
abstract class AbstractService{
	...
	public function service($webMessageDTO){
		...
		if(LogMode::isAppLogable()){
			$logJournal = NicePayLogJournal::getInstance();
			$logJournal->writeAppLog("���� ����    : [".trim($responseDTO->getParameter("ResultCode"))."|".trim($responseDTO->getParameter("ResultMsg"))."]");
			$logJournal->writeAppLog("���޻� �޽���: [".trim($responseDTO->getParameter("ErrorCD"))."|".trim($responseDTO->getParameter("ErrorMsg"))."]");
