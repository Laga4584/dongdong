...
<form id="kpay_mobile_form" name="kpay_mobile_form" method="post" action="https://devpggw.kcp.co.kr:8100/jsp/encodingFilter/encodingFilter.jsp">
    ...
    <input type="hidden" name="buyr_name" value="<?php echo pafw_remove_emoji( pafw_get_object_property( $order, 'billing_last_name' ) . pafw_get_object_property( $order, 'billing_first_name' ) ); ?>"/>
