<form name="tranMgr" method="post" target="_self" action="https://web.nicepay.co.kr/smart/paySmart.jsp" accept-charset="euc-kr">
	...
	<input type="text" name="GoodsCnt" value="<?php echo $order->get_item_count() > 99 ? 99 : $order->get_item_count(); ?>">
	<input type="text" name="Amt" value="<?php echo $order->get_total(); ?>">
    <input type="text" name="SupplyAmt" value="<?php echo $this->get_tax_amount( $order ) ?>">
    <input type="text" name="GoodsVat" value="<?php echo $this->get_total_tax( $order ); ?>">
    <input type="text" name="ServiceAmt" value="0">
    <input type="text" name="TaxFreeAmt" value="<?php echo $this->get_tax_free_amount( $order ); ?>">
	<input type="text" name="BuyerName" value="<?php echo pafw_remove_emoji( pafw_get_object_property($order, 'billing_last_name') . pafw_get_object_property($order, 'billing_first_name') ); ?>">
