...
<div class="nicepay-payment-fields">
    ...
    <div class="pafw-card-info" style="<?php echo ! empty( $bill_key ) ? 'display:none' : ''; ?>">
        ...
        <div class="fields-wrap">
            <div class="card_no">
                <input type="text" maxlength="16" size="16" name="pafw_nicepay_card_no" placeholder="카드번호는 '-'를 빼고 숫자만 입력해주세요." value="">
            </div>
        </div>
        ...
        <div class="fields-wrap flex">
            <div class="cert_no">
                <div>
                    <input type="text" maxlength="10" size="10" name="pafw_nicepay_cert_no" placeholder="<?php _e( '주민번호 앞 6자리', 'pgall-for-woocommerce' ); ?>" value="">
                </div>
            </div>
            <div class="cust-type">
                <div>
                    <input type="password" maxlength="2" size="2" name="pafw_nicepay_card_pw" placeholder="<?php _e( '비밀번호 앞 2자리', 'pgall-for-woocommerce' ); ?>" value="">
                </div>
            </div>
        </div>
    </div>
