...
if ( ! class_exists( 'PAFW_Admin' ) ) :
	...
	class PAFW_Admin {
		...
		static function admin_menu() {
			...
			add_submenu_page( 'pafw_setting', __( '주문상태 자동변경', 'pgall-for-woocommerce' ), __( '주문상태 자동변경', 'pgall-for-woocommerce' ), 'manage_woocommerce', 'pafw_order_status_setting', 'PAFW_Admin_Order_Status_Control_Settings::output' );
