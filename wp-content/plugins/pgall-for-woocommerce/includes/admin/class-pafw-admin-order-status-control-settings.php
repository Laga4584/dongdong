	...
	class PAFW_Admin_Order_Status_Control_Settings {
		...
		static function get_basic_setting() {
			return array (
				'type'     => 'Page',
				'class'    => 'active',
				'title'    => __( '결제 시 주문상태 설정', 'pgall-for-woocommerce' ),
				'elements' => array (
					array (
						'type'     => 'Section',
						...
						'elements' => array (
							array (
								...
								'title'     => __( '일반상품 결제(입금) 완료', 'pgall-for-woocommerce' ),
								'className' => '',
								'type'      => 'Select',
								'default'   => 'processing',
							...
							array (
								...
								"title"       => __( "가상상품 결제(입금) 완료", "pgall-for-woocommerce" ),
								"className"   => "",
								"type"        => "Select",
								'default'     => 'completed',
								'options'     => self::filter_order_statuses(),
					...
					array (
						'type'           => 'Section',
						'title'          => __( '결제 시 주문상태 상세설정', 'pgall-for-woocommerce' ),
						'hideSaveButton' => true,
						'elements'       => array (
							array (
