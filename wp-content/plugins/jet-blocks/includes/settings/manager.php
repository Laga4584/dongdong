...
class Settings {
	...
	public function __construct() {
		...
		$this->subpage_modules = apply_filters( 'jet-blocks/settings/registered-subpage-modules', array(
			...
			'jet-blocks-breadcrumbs-settings' => array(
				'class' => '\\Jet_Blocks\\Settings\\Breadcrumbs',
				'args'  => array(),
			),
		...
		add_action( 'admin_init', array( $this, 'register_settings_category' ), 10 );

		add_action( 'admin_init', array( $this, 'init_plugin_subpage_modules' ), 10 );
	}
	...
	public function init_plugin_subpage_modules() {
		...
		require jet_blocks()->plugin_path( 'includes/settings/subpage-modules/breadcrumbs.php' );
