...
class Breadcrumbs extends Page_Module_Base {
	...
	public function get_page_slug() {
		return 'jet-blocks-breadcrumbs-settings';
	}
	...
	public function get_page_name() {
		return esc_html__( 'Breadcrumbs Settings', 'jet-dashboard' );
	}
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['jet-blocks-breadcrumbs-settings'] = jet_blocks()->plugin_path( 'templates/admin-templates/breadcrumbs-settings.php' );
